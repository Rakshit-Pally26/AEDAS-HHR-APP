...
def map_nasa(request):
    return render(request, "nasa.html")

def map_nasa1(request):
    return render(request, "nasa1.html")

def map_nasa2(request):
    return render(request, "nasa2.html")

def map_groundwater(request):
    return render(request, "groundwater.html")

def map_groundwater1(request):
    return render(request, "groundwater1.html")

def map_groundwater2(request):
    return render(request, "groundwater2.html")

def map_fire1(request):
    return render(request, "fire1.html")

def map_fire2(request):
    return render(request, "fire2.html")

def map_fire3(request):
    return render(request, "fire3.html")

def map_fire4(request):
    return render(request, "fire4.html")

def map_drought1(request):
    return render(request, "seasonal_drought.html")

def map_drought2(request):
    return render(request, "monthly_drought.html")

def map_hazard(request):
    return render(request, "hazard.html")

def map_soil(request):
    return render(request, "soil.html")

def map_soil1(request):
    return render(request, "soil1.html")

def map_soil2(request):
    return render(request, "soil2.html")

def map_tool(request):
    return render(request, "tool.html")

def map_cmi(request):
    return render(request, "cmi.html")

def crop_monitor(request):
    return render(request, "crop.html")

def vdri_monitor(request):
    return render(request, "vdri.html")

def qdri_monitor(request):
    return render(request, "qdri.html")

def eddi_monitor(request):
    return render(request, "eddi.html")

def esi_monitor(request):
    return render(request, "esi.html")
...
def ContactInfo(request):
    ...
    slack=Slacker('xoxb-1141578750229-1174022059907-R3KbENKFLmOyU59eEnB52OxB')
    ...
    message_attachments= [
        {
            ...
            "callback_id": "xoxb-1141578750229-1174022059907-R3KbENKFLmOyU59eEnB52OxB",
            "actions": [
                {
                    "name": "approveuser",
                    "text": "Approve",
